...
\**************************************************************/
    ...
    #define LIGHT_COLOR_LIMIT 2.5 // Radius of the circle to take color on a shape pixel hit point
    ...
    #define NOISE_STRENGTH 0.25f // Strength of the noise on the shape color
